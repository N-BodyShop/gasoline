...
#define MDL_N_RECV_BUFFER        6
#define MDL_N_FLSH_BUFFER        1
#define MDL_N_CACHE_BUFFER       (MDL_N_RECV_BUFFER+MDL_N_FLSH_BUFFER)

#define MDL_FIRST_RECV_BUFFER     0
#define MDL_LAST_RECV_BUFFER      (MDL_N_RECV_BUFFER-1)
#define MDL_FIRST_FLSH_BUFFER    MDL_N_RECV_BUFFER
#define MDL_LAST_FLSH_BUFFER     (MDL_N_RECV_BUFFER+MDL_N_FLSH_BUFFER-1)
...
typedef struct mdlContext {
	...
	int iMaxDataSize;
	int iCaBufSize;
    int iRecvCurrent, nRecvActive;
    int iFlshCurrent, nFlshActive;
    int bReqActive[MDL_N_CACHE_BUFFER];
    char *ReqBuffer[MDL_N_CACHE_BUFFER];
