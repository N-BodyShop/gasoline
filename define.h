...
//#define DIVVCORRBAD #The DIVVCORRBAD corrector is better on average but is pathological with very uneven particle distributions
...
//#define DTTEST=1e-9 #If a dt value goes below this value, print some debug information about the particle that caused it.
...
//#define NEED_VPRED #Calculate a predicted veloctiy (this is defined all over, but I'm unsure as to its signifigance)
...
//#define OLD_KEPLER #An ugly part of the collision code to prevent hard scatterings that break perturbative assumptions.
...
//#define QUINTIC #Use a quintic spline kernel (wants 108-180 neighbours) from Dehnen & Aly 2012 (Bibcode:2012MNRAS.425.1068D)
...
//#define RTDENSITY #Use an alternate method for densities a la. Ritchie & Thomas 2001 (DOI:10.1046/j.1365-8711.2001.04268.x)
//#define RTF #-DRTDENSITY and -DRTFORCE (I don't know why we need this extra define)
#define RTFORCE //Use an alternate method for forces a la. Ritchie & Thomas 2001 (DOI:10.1046/j.1365-8711.2001.04268.x)
