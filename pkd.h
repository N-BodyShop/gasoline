...
void pkdSphStep(PKD pkd, double dCosmoFac, double dEtaCourant, double dEtauDot, double dEtaThermalCond, double dResolveJeans, int bViscosityLimitdt, double *pdtMinGas);
