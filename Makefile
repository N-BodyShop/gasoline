...
CODE_DEF = -DCHANGESOFT -DGASOLINE -DDIFFUSION -DDIFFUSIONTHERMAL -DDODVDS -DRTFORCE -DVSIGVISC -DSTARFORM -DCHABRIER -DTOPHATFEEDBACK -DUNONCOOL -DLONGRANGESTEP #-DSETTRAPFPE
EXE = gasoline.diff.rtforce.unoncool.longrangestep
