...
#CODE_DEF += -DNOMETALCOOLING
#CODE_DEF += -DNOMOLECULARHCOOLING
#CODE_DEF += -DNORMAL
...
#CODE_DEF += -DRADIATIVEBOX
#CODE_DEF += -DREDUCED_EWALD
#CODE_DEF += -DRHOSF
#CODE_DEF += -DROT_FRAME
#CODE_DEF += -DRTDENSITY
#CODE_DEF += -DRTF
CODE_DEF += -DRTFORCE
#CODE_DEF += -DRUBBLE_ZML
#CODE_DEF += -DSAND_PILE
#CODE_DEF += -DSETTRAPFPE #Enable Floating point exceptions.  VERY USEFUL for debugging.
#CODE_DEF += -DSFCONDITIONS
#CODE_DEF += -DSGN
#CODE_DEF += -DSHOCKTRACK
#CODE_DEF += -DSIMPLE_GAS_DRAG
#CODE_DEF += -DSIMPLESF
#CODE_DEF += -DSINKDBG
#CODE_DEF += -DSINKEXTRADATA
#CODE_DEF += -DSINKFREEZE
#CODE_DEF += -DSINKING
#CODE_DEF += -DSINKINGAVERAGE
#CODE_DEF += -DSINKINGOUTVPRED
#CODE_DEF += -DSLIDING_PATCH
#CODE_DEF += -DSNIA_TST
#CODE_DEF += -DSPECIAL_PARTICLES
#CODE_DEF += -DSSFDEBUG
