...
typedef struct AGBContext
{
    double Cej[5][13],Nej[5][13],Oej[5][13];
    } * AGBPARAM;
...
typedef struct snContext 
{
  ...
  int iNSNIIQuantum;         /* Minimum # of SN allowed per timestep
				*/
    double dRadPresFrac;        /* Fraction of early stellar radiation
				   energy */
  ...
  double dMEjexp;             /* power of stellar mass in formula
    ...
    double dMOxexp;
    double dMIronslope;
    double dMIronintercept;
    double dMOxygenslope;
    double dMOxygenintercept;
    #ifdef MORE_METALS
    double dMCslope;
  double dMCintercept;
  double dMNslope ;
  double dMNintercept;
  double dMNeslope;
  double dMNeintercept;
  double dMMgslope;
  double dMMgintercept;
  double dMSislope;
    double dMSiintercept;
#endif /*MORE_METALS*/
